...
import type { borderStyleType, cssDirectionType, cssstyle, linearDeep, linearDeepType, linearDirectionType, tmVuetify } from './interface'
import { borderStyle, cssDirection, linearDirection } from './interface'
